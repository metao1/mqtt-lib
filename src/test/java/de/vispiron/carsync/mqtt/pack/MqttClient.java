...
public interface MqttClient {
     ...
     */
    Boolean setEventLoop(EventLoopGroup eventLoop);
     ...
     * @return A future which will be completed when the server acknowledges our subscribe request
     */
    Future<Void> subscribeToTopic(String topic, MqttHandler handler, MqttQoS qos);
     ...
     * @return A future which will be completed when the server acknowledges our subscribe request
     */
    Future<Void> subscribeToTopic(String topic, MqttHandler handler);
     ...
     */
    Boolean setCallback(MqttClientCallback callback);
