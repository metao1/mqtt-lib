...
import static de.vispiron.carsync.mqtt.models.PacketTypeMessage.*;
	...
	public void channelRead(ChannelHandlerContext ctx, Object message) throws Exception {
		...
		try {
			...
			case DISCONNECT:
				...
				break;
			case SUBSCRIBE:
				protocolAnalyser.processSubscribe(ctx.channel(), (SubscribeMessage) message);
				break;
			case UNSUBSCRIBE:
				//protocolAnalyser.processUnsubscribe(ctx.channel(),(Unsubscripe));
				break;
			default:
